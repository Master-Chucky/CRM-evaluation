...
CREATE  TABLE configurations ( 
	id                   BIGINT UNSIGNED   NOT NULL AUTO_INCREMENT  PRIMARY KEY,
	remise_globale       DECIMAL(5,2)  DEFAULT ('0.00')  NOT NULL   ,
	created_at           TIMESTAMP       ,
	updated_at           TIMESTAMP       
...
CREATE  TABLE oauth_access_tokens ( 
	id                   VARCHAR(100)   COLLATE utf8mb3_unicode_ci NOT NULL   PRIMARY KEY,
	user_id              BIGINT UNSIGNED      ,
	client_id            BIGINT UNSIGNED   NOT NULL   ,
	name                 VARCHAR(255)   COLLATE utf8mb3_unicode_ci    ,
...
CREATE  TABLE oauth_clients ( 
	...
	user_id              BIGINT UNSIGNED      ,
	name                 VARCHAR(255)   COLLATE utf8mb3_unicode_ci NOT NULL   ,
	secret               VARCHAR(100)   COLLATE utf8mb3_unicode_ci    ,
	provider             VARCHAR(255)   COLLATE utf8mb3_unicode_ci    ,
